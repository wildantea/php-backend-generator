    ...
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                                   <div class="box-header">
                                    <h3 class="box-title">Edit Coba</h3>
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/coba/coba_action.php?act=up">
                      <div class="form-group">
                        <label for="nama_kegiatan" class="control-label col-lg-2">nama_kegiatan</label>
                        <div class="col-lg-10">
                          <input type="text" name="nama_kegiatan" value="<?=$data_edit->nama_kegiatan;?>" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
