...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/group_user/group_user_action.php?act=up">
                      <div class="form-group">
                        <label for="Level User" class="control-label col-lg-2">Level User</label>
                        <div class="col-lg-10">
                          <input type="text" id="level" name="level" value="<?=$data_edit->level;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Deskripsi" class="control-label col-lg-2">Deskripsi</label>
                        <div class="col-lg-10">
                          <input type="text" id="deskripsi" name="deskripsi" value="<?=$data_edit->deskripsi;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
