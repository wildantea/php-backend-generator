...
$list_table ='
  ...
  $edit = \'<a href="\'.base_index()."'.str_replace(" ", "-", $_POST['page_name'])."/edit/'+aData[indek]+'"."\".'\" class=\"btn btn-primary btn-flat\"><i class=\"fa fa-pencil\"></i></a>\';
  } else {".'
    $edit ="";
  }
  if ($role_act[\'del_act\']==\'Y\') {
   $del = "<span data-id=\'+aData[indek]+\' data-uri=".base_admin()."modul/'.str_replace(" ", "_", $_POST['page_name']).'/'.str_replace(" ", "_", $_POST['page_name']).'_action.php".\' class="btn btn-danger hapus btn-flat"><i class="fa fa-trash"></i></span>\';
  } else {
    $del="";
  }
                   } 
